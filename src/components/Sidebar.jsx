  ...
  `}
    >
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Home</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Gaming</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Automobiles</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Sports</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Entertainment</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Technology</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Music</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>Blogs</p>
      </div>
      <div
        className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md"
      ...
      >
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>News</p>
      </div>
      <hr
        className={`w-full h-1 text-slate-400 mt-2 ${menu ? "w-[20%]" : "w-[5%]"}`}
      />
      <h1 className={`font-bold text-sm ${hidden}`}>Subscription</h1>
      <div className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md">
        ...
        <p className={`text-sm font-semibold  ${hidden}`}>cameron</p>
      </div>
      <div className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md">
        <img src={jack_Icon} className="h-5 rounded-full " />
        <p className={`text-sm font-semibold  ${hidden}`}>Jack</p>
      </div>
      <div className="flex items-center gap-4 w-full hover:bg-slate-200 px-2 py-1 cursor-pointer duration-300 rounded-md">
        <img src={megan_Icon} className="h-5 rounded-full " />
        <p className={`text-sm font-semibold  ${hidden}`}>Megan</p>
      </div>
    </div>
  );
};
